...
The Chi-squared value is 0.00000006668 is too small, so vaccine is not effective in preventing spread of vaccine among LGBTQ. Based on the Fisher's Exact test P-value are 0.00000000000004631. We fail to reject the null hypothesis. If you take the placebo or covid you are in the same likely hood of receiving covid if you are a LGBTQ.
...
The Chi-squared value is p-value 0.000000002842 is too small, so vaccine is not effective in preventing spread of Covid-19 among other people. Based on the Fisher's Exact test the p-value is 0.000000000232. We fail to reject the null hypothesis. The information provided shows that the vaccine does not prevent Covid.
