...
The Chi-squared p-value is 0.002732the p-value is too small, so the vaccine is not effective in preventing covid-19 among females. Based on the Fisher's Exact test the p-value is 0.0002162. We failed to reject the null hypothesis, because the p-value is too small.
